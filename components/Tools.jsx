...
const Tools = () => {
    ...
    return (
    <div id='tools' className='w-full lg:h-screen p-2 '>
    <div className='max-w-[1240px] mx-auto flex flex-col justify-center h-full mt-20'>
      ...
      <h2 className='py-4'>What tools I use</h2>
      <div className='grid grid-cols-2 lg:grid-cols-4 gap-8'>
        <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300 shadow-[#6f3d01a5] hover:shadow-[#ad7e44]'>
