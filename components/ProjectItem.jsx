...
const ProjectItem = ({title, backgroundImg, projectUrl,tech}) => {
  return (
    <div className='relative flex items-center justify-center h-auto w-full shadow-xl mt-5 shadow-gray-400 rounded-xl p-4 group hover:bg-gradient-to-r from-[#dab890] to-[#e9dccd] transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 duration-300'>
